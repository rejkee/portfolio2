...
- フロントエンド: HTML5, CSS (Tailwind, Bootstrap, Vuetify), JavaScript/TypeScript (Vue/Nuxt), WordPress
- バックエンド: Python, php (Laravel), Ruby, Node.js, Nitro
- 他: GCP, AWS, Azure, NoSQL, SQL, Git, Docker, Linux, LLMs

### 学歴と職歴

- 株式会社 TechFlag (2024年10月\~)
- 株式会社 WitOne (2023年10月\~2024年9月)
